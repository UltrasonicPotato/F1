...
export function ContactPage() {
  ...
  const socialLinks = [
    { icon: Mail, label: 'Email', value: 'info@colibriracing.com', href: 'mailto:info@colibriracing.com' },
    { icon: Instagram, label: 'Instagram', value: '@colibriracing', href: 'https://instagram.com' },
    { icon: Linkedin, label: 'LinkedIn', value: 'Colibrí Racing', href: 'https://linkedin.com' },
    ...
    <section className="py-24 px-4 bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="bg-gradient-to-br from-[#16161d] to-[#1e1e2e] rounded-2xl border border-white/10 p-8 shadow-2xl">
            <h3 className="text-2xl mb-6 text-white">Envíanos un mensaje</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0a0a0f] border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className="w-full px-4 py-3 bg-[#0a0a0f] border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white resize-none"
                  required
                ></textarea>
              </div>
          ...
          {/* Contact Information */}
          <div>
            <div className="bg-gradient-to-br from-[#16161d] to-[#1e1e2e] rounded-2xl border border-white/10 p-8 mb-8 shadow-2xl">
            ...
            <div className="bg-gradient-to-r from-emerald-500 via-cyan-500 to-fuchsia-500 rounded-2xl p-8 text-white shadow-2xl shadow-cyan-500/30">
