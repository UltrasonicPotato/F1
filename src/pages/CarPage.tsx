  ...
  return (
    <section className="py-24 px-4 bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Car Image */}
        <div className="mb-16 rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-cyan-500/20">
          <ImageWithFallback
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-16">
          {specs.map((spec, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-[#16161d] to-[#1e1e2e] p-8 rounded-xl border border-white/10 hover:border-cyan-500/50 transition-all text-center hover:shadow-lg hover:shadow-cyan-500/20"
              >
        ...
        {/* Development Process */}
        <div className="mt-16 bg-gradient-to-r from-emerald-500 via-cyan-500 to-fuchsia-500 rounded-2xl p-12 text-white shadow-2xl shadow-cyan-500/30">
